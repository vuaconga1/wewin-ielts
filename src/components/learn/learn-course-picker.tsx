...
import { learnCourseHref } from "@/lib/learn/hrefs";
...
export function LearnCoursePicker({ courses }: Props) {
    ...
    <div className="space-y-4">
      <header data-tour="learn-header" className="min-w-0">
        ...
        <p className="mt-1 text-sm text-zinc-600">
          {t("catalogDesc", "Chọn khóa học để bắt đầu học 4 kỹ năng IELTS.")}
        </p>
      </header>

      {courses.length === 0 ? (
        <div
          data-tour="learn-courses"
